...
START_TEST(from_float_to_decimal_0) {
  ...
  ck_assert_str_eq(array_of_decimal(val, 0), cmp);
}
END_TEST
...
START_TEST(from_float_to_decimal_3) {
  ...
  int cmp_exp = 7;
  s21_from_float_to_decimal(tmp, &val);
  ck_assert_str_eq(array_of_decimal(val, 0), cmp_mantiss);
  ck_assert_int_eq(get_exp(val), cmp_exp);
}
END_TEST
...
START_TEST(add_test00) {
  s21_decimal a, b, res;
  char *res_1 = "77476325127618979434.6";
  init_decimal(&a, 1, 21, 0);
  init_decimal(&b, 1, 21, 0);
  s21_add(a, b, &res);
  ck_assert_str_eq(array_of_decimal(res, 0), res_1);
  init_decimal(&a, 0, 0xFFFFFFFF, 0);
  init_decimal(&b, 1, 321, 0);
  ck_assert_int_eq(s21_add(a, b, &res), 1);
  init_decimal(&a, 0, 0xFFFFFFFF, 1);
  init_decimal(&b, 1, 321, 1);
  ck_assert_int_eq(s21_add(a, b, &res), 2);
  init_decimal(&a, 15, 356, 1);
  init_decimal(&b, 14, 25, 0);
  char *res_2 = "-1955354.872268479004778";
  s21_add(a, b, &res);
  ck_assert_str_eq(array_of_decimal(res, 0), res_2);
}
END_TEST

START_TEST(sub_test00) {
  s21_decimal a, b, res;
  char *res_1 = "79228162514264337593543950334";
  init_decimal(&a, 0, 0xFFFFFFFF, 0);
  init_decimal(&b, 1, 0, 0);
  b.bits[0] = 6;
  s21_sub(a, b, &res);
  ck_assert_str_eq(array_of_decimal(res, 0), res_1);
  char *res_2 = "-18409850589848509875174";
  init_decimal(&a, 28, 2, 0);
  init_decimal(&b, 25, 1, 0);
  s21_sub(a, b, &res);
  ck_assert_str_eq(array_of_decimal(res, 0), res_2);
  char *res_3 = "79228162514264337593543950335";
  init_decimal(&a, 0, 0xFFFFFFFF, 0);
  init_decimal(&b, 1, 0, 0);
  b.bits[0] = 4;
  s21_sub(a, b, &res);
  ck_assert_str_eq(array_of_decimal(res, 0), res_3);
}
END_TEST

START_TEST(mul_test00) {
  s21_decimal a, b, res;
  char *res_1 = "-62771017353866807638357894230";
  init_decimal(&a, 20, 0xFFFFFFFF, 0);
  init_decimal(&b, 28, 0xFFFFFFFF, 1);
  s21_mul(a, b, &res);
  ck_assert_str_eq(array_of_decimal(res, 1), res_1);
  char *res_2 = "62771017353866807638357894230";
  init_decimal(&a, 20, 0xFFFFFFFF, 0);
  init_decimal(&b, 28, 0xFFFFFFFF, 0);
  s21_mul(a, b, &res);
  ck_assert_str_eq(array_of_decimal(res, 1), res_2);
  char *res_3 = "-16346618132041049889800889834";
  init_decimal(&a, 25, 0xAAAAAA, 0);
  init_decimal(&b, 28, 0xFFFFFFFF, 1);
  s21_mul(a, b, &res);
  ck_assert_str_eq(array_of_decimal(res, 1), res_3);
  init_decimal(&a, 0, 0xFFFFFFFF, 0);
  init_decimal(&b, 0, 0, 0);
  b.bits[0] = 2;
  ck_assert_int_eq(s21_mul(a, b, &res), 1);
  init_decimal(&a, 0, 0xFFFFFFFF, 0);
  init_decimal(&b, 0, 0, 1);
  b.bits[0] = 2;
...
int main(void) {
  ...
  tcase_add_test(tc1_1, add_test00);
  tcase_add_test(tc1_1, sub_test00);
  tcase_add_test(tc1_1, mul_test00);
